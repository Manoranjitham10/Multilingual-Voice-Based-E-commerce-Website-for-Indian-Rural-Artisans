...
export default function CustomerLoginPage() {
  ...
  const translations = {
    ...
    ta: {
      title: 'சிறு வணிகம்',
      subtitle: 'வாடிக்கையாளர் உள்நுழைவு',
      mobile: 'மொபைல் எண்',
      password: 'கடவுச்சொல்',
      login: 'உள்நுழைவு',
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-blue-100">
          ...
          <div className="mt-6 space-y-4">
            <button
              ...
              className="w-full bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 transition-colors font-medium flex items-center justify-center gap-2 whitespace-nowrap"
            >
            ...
            <div className="text-center space-y-2">
              <Link href="/customer-register" className="block text-blue-600 hover:text-blue-700 font-medium">
                {t.register}
              </Link>
